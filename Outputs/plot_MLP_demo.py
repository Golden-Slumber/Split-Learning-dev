...
def plot_results(res, obj, tau2_list, data_name, legends):
    ...
    image_name = home_dir + 'Outputs/MLP_demo_versus_noise_' + data_name + '_accuracy.pdf'
    fig.savefig(image_name, format='pdf', dpi=1200)
    plt.show()
    ...
    image_name = home_dir + 'Outputs/MLP_demo_versus_noise_' + data_name + '_objective.pdf'
    fig.savefig(image_name, format='pdf', dpi=1200)
    plt.show()
...
if __name__ == '__main__':
    ...
    for r in range(repeat):
        file_name = home_dir + 'Outputs/MLP_demo_' + data_name + '_nvar-range_' + str(
